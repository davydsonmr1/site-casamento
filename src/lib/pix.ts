// Substituir pela chave PIX real dos noivos antes de publicar.
// Obs.: ofuscar a chave no bundle do navegador é teatro de segurança — qualquer
...
export const PIX_KEY = "juliadasilvaramos9@gmail.com";
